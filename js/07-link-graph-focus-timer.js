...
/* Faz 4c — Özellik-yerel durum bu dosyaya IIFE ile kapatıldı. Dışarıdan
   (js/03, js/06) çağrılan fonksiyonlar dosya sonunda window.* ile açılır. */
(function() {
    ...
    /* Faz 4c — bu dosyanın dışından (js/03, js/06) çağrılan fonksiyonlar için köprü */
    window.openLinkGraph = openLinkGraph;
    window.closeLinkGraph = closeLinkGraph;
    window.toggleTypewriterMode = toggleTypewriterMode;
    window.recordActivityToday = recordActivityToday;
